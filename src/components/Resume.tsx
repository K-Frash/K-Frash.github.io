  ...
  return (
    <>
      <Helmet
        ...
        title="Resume | Kris Frasheri"
        titleTemplate="%s"
        meta={[
          {
            name: "description",
            content:
              "View the resume of Kris Frasheri, including experience, education, and academic service across AI, HCI and Graphics domains.",
          },
          {
            name: "keywords",
            content:
              "Kris Frasheri, resume, CV, experience, education, academic service, honours, University of Waterloo, computer science, AI, HCI",
          },
          { name: "author", content: "Kris Frasheri" },
          { property: "og:title", content: "Resume | Kris Frasheri" },
          {
            property: "og:description",
            content:
              "Explore the resume of Kris Frasheri, including experience, education, and academic service across AI, HCI and Graphics domains.",
          },
          { property: "og:type", content: "website" },
          { property: "og:url", content: "https://krisfrasheri.com/resume/" },
          {
            property: "og:image",
          ...
          { name: "twitter:title", content: "Resume | Kris Frasheri" },
          {
            name: "twitter:description",
            content:
              "View the resume of Kris Frasheri - AI & HCI researcher at the University of Waterloo.",
          },
          {
            name: "twitter:image",
            content: "https://krisfrasheri.com/assets/about/profile.jpg",
        ...
        link={[{ rel: "canonical", href: "https://krisfrasheri.com/resume/" }]}
      />
      <motion.div
        class={style.body}
        initial="hidden"
